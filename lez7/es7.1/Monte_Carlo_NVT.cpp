...
// contribution to energy and virial
  ...
  ofstream EnIst,PresIst;

  EnIst.open("EPot_Ist_solid.o",ios::app);
  EnIst << accu <<" " <<walker[iv]/(double)npart + vtail<<endl;
  EnIst.close();

  PresIst.open("Pres_Ist_solid.o",ios::app);
  PresIst << accu <<" " <<rho * temp + (walker[iw] + ptail * (double)npart) / vol<<endl;
  PresIst.close();
